...
function getPrompts() {
  ...
  characterLenght =(prompt("how many characters you want your password to be(8 - 128)"));



  if (isNaN(characterLenght) || characterLenght < 8 || characterLenght > 128) {

    alert('character lenght has to be a number,8 - 128 digits. try again please.');
    return false;
  }
